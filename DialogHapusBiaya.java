 ...
 * @author Faris
 */
public class DialogHapusBiaya extends javax.swing.JDialog {
    ...
    public DialogHapusBiaya(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hapus Data Biaya Proyek\n", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        Tabel1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Proyek", "Nama", "Uang Sponsor", "Estimasi Biaya", "Detail Baya", "Pemasukan ", "Detail Pemasukan", "Pengeluaran", "Detail Pengeluaran"
            }
        ));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lihat Semua Data Biaya Proyek", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        Tabel2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Proyek", "Nama", "Uang Sponsor", "Estimasi Biaya", "Detail Biaya", "Pemasukan", "Detail Pemasukan", "Pengeluaran", "Detail Pengeluaran"
            }
        ));
    ...
    private void FieldCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FieldCariKeyReleased
        ...
        String query ="select * from biaya where kodeProyek like '%"+FieldCari.getText()+"%' || nama like '%"+FieldCari.getText()+"%' || estimasiBiaya like '%"+FieldCari.getText()+"%'";
        fetchData(query);
        ...
        public void actionPerformed(ActionEvent ae){                        
            try{
                if(Tabel1.getSelectedRow()!= -1){
                    b.setKodeProyek(Tabel1.getValueAt(Tabel1.getSelectedRow(), 0).toString());
                    try {
                        b.deleteBiaya();
                    } catch (SQLException ex) {
                        Logger.getLogger(DialogHapusBiaya.class.getName()).log(Level.SEVERE, null, ex);
                    }                    
