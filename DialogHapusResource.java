 ...
 * @author Wahyu
 */
public class DialogHapusResource extends javax.swing.JDialog {
    ...
    public DialogHapusResource(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hapus Data Resource Proyek\n", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lihat Semua Data Resource Proyek", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void FieldCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FieldCariKeyReleased
        ...
        String query ="select * from resource where IdPegawai like '%"+FieldCari.getText()+"%' || nama like '%"+FieldCari.getText()+"%' || jabatan like '%"+FieldCari.getText()+"%'";
        fetchData(query);
        ...
        public void actionPerformed(ActionEvent ae){                        
            try{
                if(Tabel1.getSelectedRow()!= -1){
                    r.setIdPegawai(Tabel1.getValueAt(Tabel1.getSelectedRow(), 0).toString());
                    try {
                        r.deleteResource();
                    } catch (SQLException ex) {
                        Logger.getLogger(DialogHapusResource.class.getName()).log(Level.SEVERE, null, ex);
                    }                    
